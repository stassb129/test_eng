...
begin
MessageBox(Handle, 'Примечание: В случае возврата на главную форму прогресс будет сохранен.', 'Тест 1', 0);
   Form1.Visible:= True;
   Form3.Visible:= False;
...
begin
  ...
  // Загружаем вопросы в Label8, Label9, Label21 и Label23
  if not Form3.ADOQuery3.IsEmpty then
  begin
    Form3.Label8.Caption :='39. ' + Form3.ADOQuery3.Fields[0].AsString; // Первая строка
    Form3.ADOQuery3.Next;
    if not Form3.ADOQuery3.IsEmpty then
    begin
      Form3.Label9.Caption :='40. ' + Form3.ADOQuery3.Fields[0].AsString; // Вторая строка
      Form3.ADOQuery3.Next;
      if not Form3.ADOQuery3.IsEmpty then
      begin
        Form3.Label21.Caption :='41. ' + Form3.ADOQuery3.Fields[0].AsString; // Третья строка
        Form3.ADOQuery3.Next;
        if not Form3.ADOQuery3.IsEmpty then
          Form3.Label23.Caption :='42. ' + Form3.ADOQuery3.Fields[0].AsString; // Четвертая строка
      end;
    end;
  end;
end;
...
begin
  ...
  begin
    Form3.Label12.Caption :='43. ' + Form3.ADOQuery4.Fields[0].AsString; // Первая строка
    Form3.ADOQuery4.Next;
    if not Form3.ADOQuery4.IsEmpty then
    begin
      Form3.Label13.Caption :='44. ' + Form3.ADOQuery4.Fields[0].AsString; // Вторая строка
      Form3.ADOQuery4.Next;
      if not Form3.ADOQuery4.IsEmpty then
      begin
        Form3.Label24.Caption :='45. ' + Form3.ADOQuery4.Fields[0].AsString; // Третья строка
        Form3.ADOQuery4.Next;
        if not Form3.ADOQuery4.IsEmpty then
          Form3.Label25.Caption :='46. ' + Form3.ADOQuery4.Fields[0].AsString; // Четвертая строка
      end;
    end;
  end;
end;
...
begin
  ...
  if not Form3.ADOQuery5.IsEmpty then
    Form3.Label16.Caption := Form3.ADOQuery5.Fields[0].AsString; // Первая строка
end;
