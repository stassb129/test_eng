...
begin
MessageBox(Handle, 'Примечание: В случае возврата на главную форму прогресс будет сохранен.', 'Тест 4', 0);
   Form1.Visible:= True;
   Form5.Visible:= False;
...
//   Выполняем SQL-запрос для выбора ответов к вопросу с заданным ID
  ...
  Form5.ADOQuery1.SQL.Text := 'SELECT [answer text] FROM answers WHERE [answer ID] = :QuestionID';
  Form5.ADOQuery1.Parameters.ParamByName('QuestionID').Value := QuestionID;
  ...
  begin
    RadioGroup.Items.Add(Form5.ADOQuery1.FieldByName('answer text').AsString);
...
begin
  Form5.ADOQuery1.Close;
  Form5.ADOQuery1.SQL.Text := 'SELECT TOP 36 * FROM questions';
  Form5.ADOQuery1.Open;
  ...
  try
    ...
    while not Form5.ADOQuery1.Eof do
    begin
      Questions.Add(TQuestion.Create(Form5.ADOQuery1.FieldByName('question text').AsString,
                    Form5.ADOQuery1.FieldByName('code').AsInteger));
      Form5.ADOQuery1.Next;
    end;
    ...
    begin
      ...
      case i of
      0: begin
               Form5.RadioGroup1.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup1);
         end;
      1: begin
               Form5.RadioGroup2.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup2);
         end;
      2: begin
               Form5.RadioGroup3.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup3);
         end;
      3: begin
               Form5.RadioGroup4.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup4);
         end;
      4: begin
               Form5.RadioGroup5.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup5);
         end;
      5: begin
               Form5.RadioGroup6.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup6);
         end;
      6: begin
               Form5.RadioGroup7.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup7);
         end;
      7: begin
               Form5.RadioGroup8.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup8);
         end;
      8: begin
               Form5.RadioGroup9.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup9);
         end;
      9: begin
               Form5.RadioGroup10.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup10);
         end;
      10: begin
               Form5.RadioGroup11.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup11);
         end;
      11: begin
               Form5.RadioGroup12.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup12);
         end;
      12: begin
               Form5.RadioGroup13.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup13);
         end;
      13: begin
               Form5.RadioGroup14.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup14);
         end;
      14: begin
               Form5.RadioGroup15.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup15);
         end;
      15: begin
               Form5.RadioGroup16.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup16);
         end;
      16: begin
               Form5.RadioGroup17.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup17);
         end;
      17: begin
               Form5.RadioGroup18.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup18);
         end;
      18: begin
               Form5.RadioGroup19.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup19);
         end;
      19: begin
               Form5.RadioGroup20.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup20);
         end;
      20: begin
               Form5.RadioGroup21.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup21);
         end;
      21: begin
               Form5.RadioGroup22.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup22);
         end;
      22: begin
               Form5.RadioGroup23.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup23);
         end;
      23: begin
               Form5.RadioGroup24.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup24);
         end;
      24: begin
               Form5.RadioGroup25.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup25);
         end;
      25: begin
               Form5.RadioGroup26.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup26);
         end;
      26: begin
               Form5.RadioGroup27.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup27);
         end;
      27: begin
               Form5.RadioGroup28.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup28);
         end;
      28: begin
               Form5.RadioGroup29.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup29);
         end;
      29: begin
               Form5.RadioGroup30.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup30);
         end;
      30: begin
               Form5.RadioGroup31.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup31);
         end;
      31: begin
               Form5.RadioGroup32.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup32);
         end;
      32: begin
               Form5.RadioGroup33.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup33);
         end;
      33: begin
               Form5.RadioGroup34.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup34);
         end;
      34: begin
               Form5.RadioGroup35.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup35);
         end;
      35: begin
               Form5.RadioGroup36.Caption := IntToStr(QuestionNumber) + '. ' + Questions[RandomIndex].Text;
               LoadAnswersForQuestion(Questions[RandomIndex].ID, Form5.RadioGroup36);
         end;
      end;
...
begin
  ...
  begin
    ...
    Form5.ADOQuery1.Close;
    Form5.ADOQuery1.SQL.Text := 'SELECT [correct answer] FROM answers WHERE [answer text] = :SelectedAnswer';
    Form5.ADOQuery1.Parameters.ParamByName('SelectedAnswer').Value := SelectedAnswer;
    Form5.ADOQuery1.Open;

    // Проверяем правильность ответа
    if not Form5.ADOQuery1.IsEmpty then
    begin
      CorrectAnswer := Form5.ADOQuery1.FieldByName('correct answer').AsString;
...
begin
  ...
  Form5.ADOQuery2.SQL.Text := 'SELECT TOP 2 [question text] FROM questions';
  Form5.ADOQuery2.Open;

  // Загружаем вопросы в groupbox
  if not Form5.ADOQuery2.IsEmpty then
  begin
    Form5.Label20.Caption :='37. ' + Form5.ADOQuery2.Fields[0].AsString;
    Form5.ADOQuery2.Next;
    if not Form5.ADOQuery2.IsEmpty then
      Form5.Label22.caption :='38. ' + Form5.ADOQuery2.Fields[0].AsString;
  end;
end;
...
begin
  ...
  Form5.ADOQuery2.Close;
  Form5.ADOQuery2.SQL.Text := 'SELECT [answer text], [correct answer] FROM answers';
  Form5.ADOQuery2.Open;

  // Перемещаем указатель на нужное место в результате запроса
  RowIndex := 0;
  while not Form5.ADOQuery2.Eof and (RowIndex < StartIndex) do
  begin
    Form5.ADOQuery2.Next;
    Inc(RowIndex);
  end;
  ...
  begin
    if (GroupBox.Controls[i] is TRadioButton) and (not Form5.ADOQuery2.Eof) then
    begin
      RadioButton := TRadioButton(GroupBox.Controls[i]);
      RadioButton.Caption := Form5.ADOQuery2.FieldByName('answer text').AsString;
      RadioButton.Tag := Ord(Form5.ADOQuery2.FieldByName('correct answer').AsBoolean);
      Form5.ADOQuery2.Next;
...
begin
  ...
  Form5.ADOQuery3.SQL.Text := 'SELECT TOP 4 [question text] FROM questions';
  Form5.ADOQuery3.Open;

  // Загружаем вопросы в Label
  if not Form5.ADOQuery3.IsEmpty then
  begin
    Form5.Label8.Caption :='39. ' + Form5.ADOQuery3.Fields[0].AsString; // Первая строка
    Form5.ADOQuery3.Next;
    if not Form5.ADOQuery3.IsEmpty then
    begin
      Form5.Label9.Caption :='40. ' + Form5.ADOQuery3.Fields[0].AsString; // Вторая строка
      Form5.ADOQuery3.Next;
      if not Form5.ADOQuery3.IsEmpty then
      begin
        Form5.Label21.Caption :='41. ' + Form5.ADOQuery3.Fields[0].AsString; // Третья строка
        Form5.ADOQuery3.Next;
        if not Form5.ADOQuery3.IsEmpty then
          Form5.Label23.Caption :='42. ' + Form5.ADOQuery3.Fields[0].AsString; // Четвертая строка
      end;
    end;
  end;
end;
...
begin
    ...
    Form5.ADOQuery3.SQL.Text := 'SELECT [answer text] FROM answers WHERE code = :answer_index';
    // Устанавливаем значение параметра :answer_index для запроса
    Form5.ADOQuery3.Parameters.ParamByName('answer_index').Value := AnswerIndex;
...
procedure TForm5.Edit9Enter(Sender: TObject);
begin
...
procedure TForm5.Edit9Exit(Sender: TObject);
begin
...
begin
  ...
  Form5.ADOQuery4.SQL.Text := 'SELECT TOP 4 [question text] FROM questions';
  Form5.ADOQuery4.Open;

  // Загружаем вопросы в Label
  if not Form5.ADOQuery4.IsEmpty then
  begin
    Form5.Label12.Caption :='43. ' + Form5.ADOQuery4.Fields[0].AsString; // Первая строка
    Form5.ADOQuery4.Next;
    if not Form5.ADOQuery4.IsEmpty then
    begin
      Form5.Label13.Caption :='44. ' + Form5.ADOQuery4.Fields[0].AsString; // Вторая строка
      Form5.ADOQuery4.Next;
      if not Form5.ADOQuery4.IsEmpty then
      begin
        Form5.Label24.Caption :='45. ' + Form5.ADOQuery4.Fields[0].AsString; // Третья строка
        Form5.ADOQuery4.Next;
        if not Form5.ADOQuery4.IsEmpty then
          Form5.Label25.Caption :='46. ' + Form5.ADOQuery4.Fields[0].AsString; // Четвертая строка
      end;
    end;
  end;
end;
...
begin
    ...
    Form5.ADOQuery4.Close;
    // Устанавливаем текст SQL запроса для получения текста ответа из базы данных по индексу
    Form5.ADOQuery4.SQL.Text := 'SELECT [answer text] FROM answers WHERE code = :answer_index';
    // Устанавливаем значение параметра :answer_index для запроса
    Form5.ADOQuery4.Parameters.ParamByName('answer_index').Value := AnswerIndex;
    // Открываем ADOQuery3 для выполнения запроса
    Form5.ADOQuery4.Open;
    if not Form5.ADOQuery4.IsEmpty then
...
procedure TForm5.Edit10Exit(Sender: TObject);
begin
...
procedure TForm5.Edit11Enter(Sender: TObject);
begin
...
begin
  ...
  Form5.ADOQuery5.SQL.Text := 'SELECT TOP 1 [question text] FROM questions';
  Form5.ADOQuery5.Open;

  // Загружаем вопросы в Label
  if not Form5.ADOQuery5.IsEmpty then
    Form5.Label16.Caption := Form5.ADOQuery5.Fields[0].AsString; // Первая строка
end;
...
begin
    ...
    Form5.ADOQuery5.Close;
    // Устанавливаем текст SQL запроса для получения текста ответа из базы данных по индексу
    Form5.ADOQuery5.SQL.Text := 'SELECT [answer text] FROM answers WHERE code = :answer_index';
    // Устанавливаем значение параметра :answer_index для запроса
    Form5.ADOQuery5.Parameters.ParamByName('answer_index').Value := AnswerIndex;
    // Открываем ADOQuery3 для выполнения запроса
    Form5.ADOQuery5.Open;
    if not Form5.ADOQuery5.IsEmpty then
...
begin
  if Form5.MediaPlayer1.NotifyValue = nvSuccessful then
  begin
...
begin
  if Form5.Label29.Caption <> '50' then
...
begin
Form5.Image1.Picture.LoadFromFile('C:\Users\XE\Desktop\test_eng\изобр\Ф3Тест1\1звук.png');
...
begin
 if MusicPlaying then
  begin
    MediaPlayer1.Stop;
    Form5.Image1.Picture.LoadFromFile('C:\Users\XE\Desktop\test_eng\изобр\Ф3Тест1\нет звука.png');
  end
  else
  begin
    MediaPlayer1.Play;
...
//вывод баллов
  Form5.Label32.Caption:= inttostr(Ball)+'/100';
  Form5.Label33.Caption:= inttostr(right);
  Form5.Label34.Caption:= inttostr(incorrect);

  Form5.Button1.visible := False;//неактивной после вывода результата

  if (ball >= 0) then   //передаём рез пользователя в бд
  begin
    // Подготавливаем SQL-запрос для обновления данных в таблице
    ADOQuery6.SQL.Text := 'UPDATE регистрация SET Test4 = :Test4 WHERE id = :ID';

    // Задаем значение параметра Test1
    ADOQuery6.Parameters.ParamByName('Test4').Value := Form5.Label32.Caption;
...
procedure TForm5.RadioGroup11Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup12Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup13Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup14Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup15Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup16Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup17Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup18Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup19Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup20Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup21Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup22Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup23Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup24Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup25Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup26Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup27Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup28Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup29Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup30Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup31Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup32Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup33Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup34Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup35Click(Sender: TObject);
begin
...
procedure TForm5.RadioGroup36Click(Sender: TObject);
begin
...
procedure TForm5.Edit2KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit9KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit3KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit4KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit10KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
...
procedure TForm5.Edit11KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
...
procedure TForm5.Edit7KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit8KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
  if IsTextChanged then
...
procedure TForm5.Edit12KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var    IsTextChanged: boolean;
begin
   IsTextChanged:= True;
